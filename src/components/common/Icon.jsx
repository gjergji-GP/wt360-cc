export function Icon({ name, size = 16, color = "currentColor" }) {
  const paths = {
    ...
    tower: <><rect x="2" y="3" width="20" height="18" rx="2" /><path d="M8 21V3M2 9h20M2 15h6" /></>,
    ...
    radio: <><circle cx="12" cy="12" r="2" /><path d="M4.93 19.07a10 10 0 0 1 0-14.14" /><path d="M7.76 16.24a6 6 0 0 1 0-8.49" /><path d="M10.59 13.41a2 2 0 0 1 0-2.83" /><path d="M19.07 4.93a10 10 0 0 1 0 14.14" /><path d="M16.24 7.76a6 6 0 0 1 0 8.49" /></>,
    ...
    flask: <><path d="M9 3h6l1 9H8L9 3z" /><path d="M6.8 21a9 9 0 0 0 10.4 0l.8-3H6l.8 3z" /><line x1="9" y1="3" x2="9" y2="12" /><line x1="15" y1="3" x2="15" y2="12" /></>,
    testtube: <><path d="M14.5 2v17.5c0 1.4-1.1 2.5-2.5 2.5s-2.5-1.1-2.5-2.5V2" /><line x1="9.5" y1="2" x2="14.5" y2="2" /><path d="M9.5 9.5h5" /></>,
